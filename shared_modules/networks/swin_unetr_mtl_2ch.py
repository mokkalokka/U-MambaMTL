...
class SwinUNETRMTL(nn.Module):
    ...
    def __init__(
        ...
        self.out0 = UnetOutBlock(spatial_dims=spatial_dims, in_channels=feature_size, out_channels=1)#out_channels)
        self.out1 = UnetOutBlock(spatial_dims=spatial_dims, in_channels=feature_size, out_channels=2)#out_channels)
    ...
    def forward(self, x_in):
        ...
        #----- decode head 0 -----#
        dec0_3 = self.decoder0_5(dec4, hidden_states_out[3])
        dec0_2 = self.decoder0_4(dec0_3, enc3)
        dec0_1 = self.decoder0_3(dec0_2, enc2)
        dec0_0 = self.decoder0_2(dec0_1, enc1)
        out0 = self.decoder0_1(dec0_0, enc0)
        logits0 = self.out0(out0)
        
        #----- decode head 1 -----#
        dec1_3 = self.decoder1_5(dec4, hidden_states_out[3])
        dec1_2 = self.decoder1_4(dec1_3, enc3)
        dec1_1 = self.decoder1_3(dec1_2, enc2)
        dec1_0 = self.decoder1_2(dec1_1, enc1)
        out1 = self.decoder1_1(dec1_0, enc0)
        logits1 = self.out1(out1)
        
        
        return torch.cat([logits0, logits1], dim=1)
