...
def get_umamba_bot_3d_from_plans(
    ...
    print(num_stages)
    print([min(configuration_manager.UNet_base_num_features * 2 ** i,
                                configuration_manager.unet_max_num_features) for i in range(num_stages)])
    print(conv_op)
    print(configuration_manager.conv_kernel_sizes)
    print(label_manager.num_segmentation_heads)
    print(conv_or_blocks_per_stage)
    print(kwargs[segmentation_network_class_name])
    
    print(configuration_manager.pool_op_kernel_sizes)
